...
let paletteDisplay = document.querySelector('.palette-display, palette-display-pop')
...
if (currentPage === 'palette.html' || currentPage === 'image.html') {
...
if (currentPage === 'palette.html' || currentPage === 'image.html' || currentPage === 'popular.html') {
    // Initalize Export Options if elements exist
...
const ThemeManager = (() => {
    ...
    const applyTheme = (theme) => {
        // Remove old theme and add new theme class to the body
    ...
    const initTheme = () => {
        ...
        // Sync the theme selector, if it exists, to the current theme
...
// Initialize the theme on every page load
document.addEventListener('DOMContentLoaded', () => {
    ThemeManager.initTheme();
});

// Additional listener for theme change event, if further customization is needed
window.addEventListener('themeChange', (e) => {
    console.log(`Theme changed to: ${e.detail.theme}`);
    applyColorBlindnessSimulation(); // Reapply simulation on theme change
});
